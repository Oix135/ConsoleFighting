        ...
        case 1:
            {
                if (playerEnergy >= 20)
                {
                    ...
                    {
                        Text = "Ты почистил реестр и нанёс 20 урона",
                ...
                else
                {
                    lstFight.Add(new MessageFight
                    {
                        Text = "Недостаточно энергии, ты пропустил этот ход",
                        ConsoleColor = ConsoleColor.DarkCyan
                    });
                }
                break;
        ...
        case 2:
            {
                if (playerEnergy >= 40)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Ты использовал Касперского и нанёс 30 урона",
                        ConsoleColor = ConsoleColor.DarkCyan
                    });
                }
                else
        ...
        case 3:
            {
                if (playerEnergy >= 10)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Ты установил обновления и восстановил 10 жизни",
                        ConsoleColor = ConsoleColor.DarkCyan
                    });
                }
                else
        ...
        case 4:
            {
                if (playerEnergy >= 20)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Ты перезагрузил компьютер и восстановил 30 жизни",
                        ConsoleColor = ConsoleColor.DarkCyan
                    });
                }
                else
        ...
        case 5:
            {
                ...
                lstFight.Add(new MessageFight
                {
                    Text = "Ты выпил кофе и восстановил 30 энергии",
                    ConsoleColor = ConsoleColor.DarkCyan
                });
                break;
            }
        default:
            {
                ...
                lstFight.Add(new MessageFight
                {
                    Text = $"Ты нажал не туда и установил элементы Яндекс. -30 жизнь, - 30 энергия",
        ...
        case 1:
            {
                if (enemyAction == action)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Во время очистки реестра выключили свет. 40 урона",
                        ConsoleColor = ConsoleColor.DarkRed
                    });
                }
                else
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус хрюкнул, сказал, что его лицензия закончилась и нанёс 20 урона",
        ...
        case 2:
            {
                ...
                else
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус установил Mail.ru agent и нанёс 30 урона",
                        ConsoleColor = ConsoleColor.Red
                    });
                }
                break;
        ...
        case 3:
            {
                if (enemyAction == action)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус установил порнуху стартовой страницей, отдохнул и восстановил 40 жизни.",
                        ConsoleColor = ConsoleColor.DarkRed
                    });
                }
                else
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус установил Вирус-Дзен с учетом твоих интересов и восстановил 20 жизни",
                        ConsoleColor = ConsoleColor.Red
                    });
                }
                break;
        ...
        case 4:
            {
                if (enemyAction == action)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус удалил со стартовой страницы поисковика всё, кроме поисковой строки," +
                        "\n написал \"Привет! Давай поболтаем?\" " +
                        "И восстановил 20 жизни",
                        ConsoleColor = ConsoleColor.DarkRed
                    });
                ...
                else
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус установил Вирус-Браузер с защитной технологией Протект и восстановил 10 жизни",
                        ConsoleColor = ConsoleColor.Red
                    });
                }
                break;
        ...
        case 5:
            {
                if (enemyAction == action)
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус заблокировал очередной VPN и восстановил 40 энергии, но, как ни старался, урона не нанёс",
                        ConsoleColor = ConsoleColor.DarkRed
                    });
                }
                else
                {
                    ...
                    lstFight.Add(new MessageFight
                    {
                        Text = "Вирус взломал учетку Одноклассников и восстановил 20 энергии, но урона не нанёс",
                        ConsoleColor = ConsoleColor.Red
                    });
                }
                break;
...
int GetEnemyAction(int enemyHealth, int enemyEnergy)
{
    //Атака
...
void NewGame(out int playerHealth, out int enemyHealth, out int playerEnergy, out int enemyEnergy, List<MessageFight> lstFight)
{
    playerHealth = 100;
    enemyHealth = 100;
    playerEnergy = 100;
